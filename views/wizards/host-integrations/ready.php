...
<div class="wu-bg-white wu-p-4 wu--mx-6 wu-flex wu-content-center" style="height: 250px;">
	...
	<p class="wu-text-lg wu-text-gray-600 wu-my-4">
		...
		<?php esc_html(sprintf(__('The integration with %s was correctly setup and is now ready! Now, every time a new domain is added to your platform, Multisite Ultimate will sync that with your application automatically.', 'ultimate-multisite'), $integration->get_title())); ?>
	</p>
	</div>
